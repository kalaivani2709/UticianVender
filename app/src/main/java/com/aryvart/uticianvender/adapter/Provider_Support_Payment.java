 ...
 */
public class Provider_Support_Payment extends BaseAdapter {
    ...
    public Provider_Support_Payment(Context cont, ArrayList<commonBeanSupport> reviewBean) {
        this.context = cont;
...

                                {
                                    try {
                                        if (!str_email.matches(emailPattern)) {
                                            Toast.makeText(context, "Invlaid email address", Toast.LENGTH_SHORT).show();
                                        } else {
    ...
    class IssueUploadTask extends AsyncTask {
        ...
        protected Object doInBackground(Object[] params) {
            try {
                ...
                multipart.addFormField("idtype", "2");
