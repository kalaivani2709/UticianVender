...
/**
 * Created by Androidwin on 1/28/2017.
 */

public class AdminNotifiationAdapater extends RecyclerView
        .Adapter<AdminNotifiationAdapater
        .DataObjectHolder> {
    ...
    public AdminNotifiationAdapater(ArrayList<ProviderNotificationBean> myDataset, Context cont) {
