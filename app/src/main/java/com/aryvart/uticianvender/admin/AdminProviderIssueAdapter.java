 ...
 */
public class AdminProviderIssueAdapter extends RecyclerView
        .Adapter<AdminProviderIssueAdapter
        .DataObjectHolder> {
    ...
    public AdminProviderIssueAdapter(ArrayList beanArrayList, Context cont) {
